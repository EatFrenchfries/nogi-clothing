...
export type SearchCategories = ActionWithPayload<CATEGORIES_ACTION_TYPES.SEARCH_CATEGORIES, string>
...
export const searchCategories = withMatcher((search: string): SearchCategories => createAction(CATEGORIES_ACTION_TYPES.SEARCH_CATEGORIES, search))
